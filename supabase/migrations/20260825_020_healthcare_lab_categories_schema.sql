-- Healthcare Laboratory category schema.
-- Creates only the two tables confirmed absent from the live project.
-- Writes remain RPC-only; dedicated write RPCs and reviewed permission seed are a
