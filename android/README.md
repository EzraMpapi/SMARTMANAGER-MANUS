...
The launcher and maskable icon are generated from the logo supplied for this project. The original source is retained at `android/assets/smart-manager-logo.png`; no replacement logo is generated by the build.
...
```text
https://bserp-dashbo-xgm6fauw.manus.space/.well-known/assetlinks.json
```
