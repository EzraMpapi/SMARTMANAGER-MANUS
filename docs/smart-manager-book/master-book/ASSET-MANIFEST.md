...
| `assets/branding/extracted-002.png` and `typst-project/assets/branding/ezra-mpapi-owner.png` | `/manus-storage/ezra-mpapi-owner_0fc38729.png` | `/home/ubuntu/webdev-static-assets/smart-manager-master-book/branding/ezra-mpapi-owner.png` |
