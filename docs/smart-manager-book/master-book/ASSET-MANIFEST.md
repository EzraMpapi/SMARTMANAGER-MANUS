...
| --- | --- | --- |
| `assets/branding/extracted-000.png` and `typst-project/assets/branding/smart-manager-logo.png` | `/manus-storage/smart-manager-logo-20260824_aa2c04d3.png` | `/home/ubuntu/webdev-static-assets/smart-manager-master-book/branding/smart-manager-logo.png` |
| `assets/branding/extracted-002.png` and `typst-project/assets/branding/ezra-mpapi-owner.png` | `/manus-storage/ezra-mpapi-owner-20260824_83575e38.png` | `/home/ubuntu/webdev-static-assets/smart-manager-master-book/branding/ezra-mpapi-owner.png` |
