# 32. School Management — Module Design Specification

**Source ID:** `school`  
**Experience family:** Education operations  
**Primary roles:** School Administrator / Teacher  
...
Design School Management as a role-aware workspace for education operations. The module should open with a clear operational question, expose the minimum data required for the current role, and make status, permission, freshness, and next action obvious.

## Screen reference

| Screen | Main components | Primary action | Secondary action | Data displayed |
|---|---|---|---|---|
| Overview / command center | KPI cards, trend/chart, alert rail, recent activity, quick actions | Open the highest-priority queue | Change scope, export snapshot | learner, guardian, class, term, attendance, assessment, fees, service |
| List / queue | Search, filters, saved views, sortable table, pagination, bulk bar | Create or open a record | Bulk update, export, clear filters | learner, guardian, class, term, attendance, assessment, fees, service; owner; status; updated time |
...
| Create / edit form | Sectioned form, required markers, inline help, validation summary | Save draft or submit | Cancel, duplicate, reset | learner, guardian, class, term, attendance, assessment, fees, service |
