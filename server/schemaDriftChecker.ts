...
const contractManifest: Record<string, SchemaTableContract> = {
  ...
  ...Object.fromEntries([
    ...
    "hc_prescriptions", "hc_lab_orders", "hc_radiology", "hc_invoices", "hc_insurance_claims", "hc_notifications", "hc_reports", "hc_reminder_settings", "hc_reminder_deliveries", "hc_portal_reference_imports", "hc_portal_reference_approvals", "hc_portal_reference_summary_settings",
