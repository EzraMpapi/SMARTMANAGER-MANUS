...
const { resolveVerifiedProfile, invokeLLM } = vi.hoisted(() => ({
  resolveVerifiedProfile: vi.fn(),
  invokeLLM: vi.fn(),
}));
vi.mock("./aiApprovals", () => ({ resolveVerifiedProfile }));
vi.mock("./_core/llm", () => ({ invokeLLM }));
import { addSupportInternalNote, createSupportTicket, draftSupportTicketReply, listSupportTickets, saveSupportSlaPolicy, saveSupportWorkflowPolicy, searchSupportTickets } from "./supportOperations";
