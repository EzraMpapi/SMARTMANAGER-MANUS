...
export default defineConfig({
  ...
  test: {
    ...
    env: {
      ...
      DASHBOARD_PREFERENCES_NO_NEW_SECRET: "dashboard-preferences-no-new-secret",
      DASHBOARD_PREFERENCE_API_INTERNAL_MARKER: "dashboard-preferences-internal",
      DASHBOARD_PREFERENCES_SCHEMA_VERSION: "1",
    },
