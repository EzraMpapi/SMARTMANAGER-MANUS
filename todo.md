...
- [ ] Select and fully upgrade the Human Resources workspace as the next verified high-priority people-operations area, covering confirmed employee and leave truthfulness, server-confirmed workflows, error recovery, accessibility, responsive behavior, and regression evidence.
- [ ] Select and fully upgrade the Manufacturing workspace as the next verified high-priority operational area, covering confirmed production and work-order truthfulness, server-confirmed workflows, error recovery, accessibility, responsive behavior, and regression evidence.
