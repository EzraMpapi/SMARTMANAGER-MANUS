...
export const marketProviderSettings = mysqlTable("market_provider_settings", {
  ...
  cbkProviderUrl: text("cbkProviderUrl"),
  cbkProviderApiKey: text("cbkProviderApiKey"),
  bouProviderUrl: text("bouProviderUrl"),
  bouProviderApiKey: text("bouProviderApiKey"),
  bnrProviderUrl: text("bnrProviderUrl"),
  bnrProviderApiKey: text("bnrProviderApiKey"),
  ...
  alertCooldownMinutes: int("alertCooldownMinutes").default(15).notNull(),
  scheduleCronTaskUid: varchar("scheduleCronTaskUid", { length: 65 }),
  lastAlertDispatchedAt: timestamp("lastAlertDispatchedAt"),
  createdAt: timestamp("createdAt").defaultNow().notNull(),
  updatedAt: timestamp("updatedAt").defaultNow().onUpdateNow().notNull(),
}, (table) => ({
