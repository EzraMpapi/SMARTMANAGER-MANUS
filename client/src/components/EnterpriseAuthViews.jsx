...
import { AlertCircle, CheckCircle2, ChevronDown, Eye, EyeOff, Globe2, LockKeyhole, Mail, RefreshCw, ShieldCheck, UserRound } from "lucide-react";
...
const copy = {
  en: {
    ...
    oauthRecoveryTitle: "Google sign-in was not completed",
    oauthRecoveryCopy: "Try Google again, or use your work email and password instead. Your workspace and account data are unchanged.",
    oauthRetry: "Try Google again",
  ...
  sw: {
    ...
    oauthRecoveryTitle: "Kuingia kwa Google hakukukamilika",
    oauthRecoveryCopy: "Jaribu Google tena, au tumia barua pepe ya kazi na nenosiri lako. Eneo lako la kazi na taarifa za akaunti havijabadilika.",
    oauthRetry: "Jaribu Google tena",
...
export function EnterpriseLoginView({ onSignIn, onSignup, onForgot, onOAuth, onClearOAuthError, toMessage, configured, initialError = null }) {
