...
import { AlertCircle, CheckCircle2, ChevronDown, Eye, EyeOff, Globe2, LockKeyhole, Mail, ShieldCheck, UserRound } from "lucide-react";
...
export function EnterpriseLoginView({ onSignIn, onSignup, onForgot, onOAuth, toMessage, configured, initialError = null }) {
